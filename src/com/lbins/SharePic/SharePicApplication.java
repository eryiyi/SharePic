 ...
 * 类的功能、说明写在此处.
 */
public class SharePicApplication extends Application {
    ...
    private static SharePicApplication application;
    ...
    private static SharePicApplication instance;

    // 构造方法
    // 实例化一次
    public synchronized static SharePicApplication getInstance() {
        if (null == instance) {
            instance = new SharePicApplication();
        }
        return instance;
    }
